...
# isolated per environment — applying here can never overwrite dev/staging/prod.
#
# Before running:
#
...
#   3. The workspace "marketo-aurora-mysql-qa" is created automatically on
#      first apply.
